...
internal class DataAdapter(private val context: Context?, var memes: MutableList<MemDto>) : RecyclerView.Adapter<DataAdapter.ViewHolder>() {
    ...
    public fun addAll(newMemes: List<MemDto>) {
    ...
    inner class ViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val shareView = view.findViewById<View>(R.id.mem_share) as ImageView
    }
}